...
| 上游模型校验 | 0.2.1 | [ZIP](https://raw.githubusercontent.com/moeacgx/maolaonewapi-extensions/main/published/upstream-model-guard/0.2.1/upstream-model-guard-0.2.1.zip) · [SHA-256](https://raw.githubusercontent.com/moeacgx/maolaonewapi-extensions/main/published/upstream-model-guard/0.2.1/upstream-model-guard-0.2.1.zip.sha256) | 增加双模板渠道 ID 白名单输入；需要 guard 与 tolerance 两项宿主能力，现有 .329 支持，无新增迁移。 |
